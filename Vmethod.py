...
# Ne fonctionne pas car il existe beaucoup de states différents

class Agent:
    def __init__(self):
        self.env = dinoEnvWithoutDisplay.dinoEnvWithoutDisplay()
    ...
    def play_n_random_steps(self, count):
        for _ in range(count):
            ...
            print(new_state, reward, is_done)
...
if __name__ == "__main__":
    test_env = dinoEnvWithoutDisplay.dinoEnvWithoutDisplay()
    agent = Agent()
